...
import { sendGroupInvitationEmail, sendPaymentReminderEmail, sendSettlementConfirmationEmail } from './services/emailService.js';
...
console.log('   USE_REAL_EMAILS:', process.env.USE_REAL_EMAILS || 'NOT SET');
